...
require([
  ...
  var view = new MapView({
   ...
   var trailheadsLayer = new FeatureLayer({
    url: "https://services.arcgis.com/8DAUcrpQcpyLMznu/arcgis/rest/services/Nutria_WFL1/FeatureServer/0"
  });

  map.add(trailheadsLayer);
  
  var trailsLayer = new FeatureLayer({
    url: "https://services.arcgis.com/8DAUcrpQcpyLMznu/arcgis/rest/services/Nutria_WFL1/FeatureServer/1"
  });
